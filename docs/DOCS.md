...
<dt><a href="#getPlayer">getPlayer(nickname)</a> ⇒ <code>Promise[PlayerContext]</code>;</dt>
<dd><p>Get player info by nickname</p>
</dd>
<dt><a href="#skinHistory">skinHistory(options)</a> ⇒ <code>Promise[SkinContext[]]</code>;</dt>
<dd><p>Get skin history by nickname</p>
</dd>

<dt><a href="#getSkins">getSkins(options)</a> ⇒ <code>Promise[SkinContext[]]</code>;</dt>
<dd><p>Get skins from a specific tab of the site</p>
</dd>
<dt><a href="#getSkin">getSkin(hash)</a> ⇒ <code>Promise[SkinContext]</code>;</dt>
<dd><p>Get information about skin</p>
</dd>
<dt><a href="#getCapes">getCapes(nickname)</a> ⇒ <code>Promise[CapeContext]</code>;</dt>
<dd><p>Get capes by nickname</p>
</dd>
<dt><a href="#getRenders">getRenders(options)</a> ⇒ <code>Promise[RendersContext]</code>;</dt>
<dd><p>Get skin renders</p>
</dd>
<dt><a href="#transformSkin">transformSkin(options)</a> ⇒ <code>Promise[SkinContext]</code>;</dt>
<dd><p>Transform skin method</p>
</dd>
<dt><a href="#getCapeInfo">getCapeInfo(hash)</a> ⇒ <code>CapeContext</code>;</dt>
<dd><p>Get cape type by cape hash</p>
</dd>

<dt><a href="#getFriends">getFriends(nickname)</a> ⇒ <code>Promise[Friend[]]</code>;</dt>
<dd><p>Get player friends by nickname</p>
</dd>

<dt><a href="#getServers">getServers(page)</a> ⇒ <code>Promise[ServerContext[]]</code>;</dt>
<dd><p>Get servers list</p>
</dd>
<dt><a href="#getServer">getServer(ip)</a> ⇒ <code>Promise[ServerContext]</code>;</dt>
<dd><p>Get server by ip</p>
</dd>
<dt><a href="#getServerLikes">getServerLikes(ip)</a> ⇒ <code>Promise[string[]]</code>;</dt>
<dd><p>Get server likes by ip</p>
</dd>
<dt><a href="#checkServerLike">checkServerLike(options)</a> ⇒ <code>Promise[boolean]</code>;</dt>
...
## getPlayer(nickname) ⇒ `Promise<PlayerContext>`;
Get player info by nickname

**Kind**: global function

**Returns**: `Promise<PlayerContext>` - Promise object with player info
...
## skinHistory(options) ⇒ `Promise<SkinContext[]>`;
Get skin history by nickname

**Kind**: global function

**Returns**: `Promise<SkinContext[]>` - Promise array with skins objects
...
## getSkins(options)⇒ `Promise<SkinContext[]>`;
...
## getSkin(hash)⇒ `Promise<SkinContext>`;
Get information about skin

**Kind**: global function

**Returns**: `Promise<SkinContext>` - Promise object with skin information
...
## getCapes(nickname) ⇒ `Promise<CapeContext[]>`;
Get capes by nickname

**Kind**: global function

**Returns**: `Promise<CapeContext[]>` - Promise array with capes objects
...
## getRenders(options) ⇒ `RendersContext`;
Get skin renders

**Kind**: global function

**Returns**: `RendersContext` - Object with renders skin
...
## transformSkin(options) ⇒ `Promise<SkinContext>`;
Transform skin method

**Kind**: global function

**Returns**: `Promise<SkinContext>` - Promise url string on transformed skin
...
## getCapeInfo(hash) ⇒ `CapeContext`;
Get cape type by cape hash

**Kind**: global function

**Returns**: `CapeContext` - Object with cape information
...
## getServers(page) ⇒ `Promise<ServerContext[]>`;
Get servers list

**Kind**: global function

**Returns**: `Promise<ServerContext[]>` - Promise array with servers objects
...
## getServer(ip) ⇒ `Promise<ServerContext[]>`;
Get server by ip

**Kind**: global function

**Returns**: `Promise<ServerContext[]>` - Promise object with server information
